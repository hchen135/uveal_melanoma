...
UMSLIC_dataset = dataset_base.copy({
    'name': 'Uveal Melanoma SLIC',

    'train_images':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno',    
    'train_info': '/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno/coco_style_anno_train.json',
    
    'valid_images':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno',
    'valid_info': '/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno/coco_style_anno_val.json',

    'class_names': UMSLIC_CLASSES,
    'label_map': UMSLIC_LABEL_MAP
})

UMSLIC_umap_gene_dataset = dataset_base.copy({
    'name': 'Uveal Melanoma SLIC umap generation',# use class 1 slides to generate umap
    # here train images will never be used
    'train_images':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno',
    'train_info': '/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno/coco_style_anno_train.json',
    'valid_images':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma ROI extracted',
    'valid_info':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno/all_slide_ROI_coco_style_file/umap_gene_coco_style.json',
    #'valid_info':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno/all_slide_ROI_coco_style_file/tmp.json',
    'class_names': UMSLIC_CLASSES,
    'label_map': UMSLIC_LABEL_MAP,
    'has_gt':False
})

UMSLIC_Nature_umap_gene_dataset = UMSLIC_umap_gene_dataset.copy({
    'name': 'Uveal Melanoma SLIC umap generation for Nature',# use class 1 slides to generate umap
    'valid_info':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno/all_slide_ROI_coco_style_file/Nature_umap_gene_coco_style.json',
})
UMSLIC_class2_umap_gene_dataset = UMSLIC_umap_gene_dataset.copy({
    'name': 'Uveal Melanoma SLIC umap generation for class2 UMAP space',# use class 1 slides to generate umap
    'valid_info':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno/all_slide_ROI_coco_style_file/class2_umap_gene_coco_style.json',
})

UMSLIC_umap_proj_dataset = UMSLIC_umap_gene_dataset.copy({
    'name': 'Uveal Melanoma SLIC umap projection', # use the existing umap mapping to project cells in specific slides
    'valid_images':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma ROI extracted',
    'valid_info':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno/all_slide_ROI_coco_style_file/other_slides_coco_style.json'
})

UMSLIC_Nature_umap_proj_dataset = UMSLIC_umap_proj_dataset.copy({
    'name': 'Uveal Melanoma SLIC umap projection', # use the existing umap mapping to project cells in specific slides
    'valid_images':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma ROI extracted',
    'valid_info':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno/all_slide_ROI_coco_style_file/Nature_other_slides_coco_style.json'
})

UMSLIC_class2_umap_proj_dataset = UMSLIC_umap_proj_dataset.copy({
    'name': 'Uveal Melanoma SLIC umap projection', # use the existing umap mapping to project cells in specific slides
    'valid_images':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma ROI extracted',
    'valid_info':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno/all_slide_ROI_coco_style_file/class2_other_slides_coco_style.json'
})

CCSLIC_dataset = dataset_base.copy({
    'name': 'Cervical Cancer SLIC training',
    'train_images':'/home/hchen135/uveal_melanoma/Nature/Cervical_cancer_data/generated_data/512x512_slide/',
    'train_info': '/home/hchen135/uveal_melanoma/Nature/Cervical_cancer_data/generated_data/coco_style_anno_train.json',
    'valid_images':'/home/hchen135/uveal_melanoma/Nature/Cervical_cancer_data/generated_data/512x512_slide/',
    'valid_info':'/home/hchen135/uveal_melanoma/Nature/Cervical_cancer_data/generated_data/coco_style_anno_val.json',
    'class_names': UMSLIC_CLASSES,
    'label_map': UMSLIC_LABEL_MAP,
})

CCSLIC_umap_gene_dataset = dataset_base.copy({
    'name': 'Cervical Cancer SLIC umap generation',# use class 1 slides to generate umap
    # here train images will never be used
    'train_images':'/home/hchen135/uveal_melanoma/Nature/Cervical_cancer_data/generated_data/512x512_slide/',
    'train_info': '/home/hchen135/uveal_melanoma/Nature/Cervical_cancer_data/generated_data/coco_style_anno_train.json',
    'valid_images':'/home/hchen135/uveal_melanoma/Nature/Cervical_cancer_data/generated_data/512x512_slide/',
    'valid_info':'/home/hchen135/uveal_melanoma/Nature/Cervical_cancer_data/generated_data/umap_gene_coco_style.json',
    #'valid_info':'/home/hchen135/uveal_melanoma/data/generated_data/Uveal Melanoma SLIC_400_40 anno/all_slide_ROI_coco_style_file/tmp.json',
    'class_names': UMSLIC_CLASSES,
    'label_map': UMSLIC_LABEL_MAP,
    'has_gt':False
...
CCSLIC_umap_proj_dataset = CCSLIC_umap_gene_dataset.copy({
    'name': 'Cervical Cancer SLIC umap projection',
    'valid_images':'/home/hchen135/uveal_melanoma/Nature/Cervical_cancer_data/generated_data/512x512_slide/',
    'valid_info':'/home/hchen135/uveal_melanoma/Nature/Cervical_cancer_data/generated_data/other_slides_coco_style.json',
})
...
yolact_base_config = coco_base_config.copy({
    ...
    #ADDED!!!
    'use_discriminative_loss': False,
    'apply_clustering':False,
})


UMSLIC_config = yolact_base_config.copy({
    'name':'UMSLIC',
    'dataset': UMSLIC_dataset,
    'num_classes':2,
    'max_iter':8000,
    'max_size':256,
    ...
    'semantic_segmentation_alpha':10,
   
    'use_discriminative_loss':False,
    'delta_var':0.5,
    'delta_dist':1.5,
    'discriminative_norm':2,
    
    'apply_clustering':True,
    'clustering_mode':'umap',

    'apply_classification':True,
    'class_info_path':'/home/hchen135/uveal_melanoma/data/generated_data/class.txt',
})

UMSLIC_umap_gene_config = UMSLIC_config.copy({
    'dataset': UMSLIC_umap_gene_dataset,
})

UMSLIC_Nature_umap_gene_config = UMSLIC_config.copy({
    'dataset': UMSLIC_Nature_umap_gene_dataset,
})

UMSLIC_class2_umap_gene_config = UMSLIC_config.copy({
    'dataset': UMSLIC_class2_umap_gene_dataset,
})

UMSLIC_umap_proj_config = UMSLIC_config.copy({
    'dataset': UMSLIC_umap_proj_dataset,
    'proj_file_name': 'umap_0.1.pkl',
})

UMSLIC_Nature_umap_proj_config = UMSLIC_config.copy({
    'dataset': UMSLIC_Nature_umap_proj_dataset,
    'proj_file_name': 'umap_0.1.pkl',
})

UMSLIC_class2_umap_proj_config = UMSLIC_config.copy({
    'dataset': UMSLIC_class2_umap_proj_dataset,
    'proj_file_name': 'umap_0.1.pkl',
})



CCSLIC_config = yolact_base_config.copy({
    'name':'CCSLIC',
    'dataset': CCSLIC_dataset,
    'num_classes':2,
    'max_size':512,
    'max_iter':8000,
    ...
    'apply_classification':True,
    'class_info_path':'/home/hchen135/uveal_melanoma/Nature/Cervical_cancer_data/generated_data/class.txt',
})

CCSLIC_umap_gene_config = CCSLIC_config.copy({
    'dataset': CCSLIC_umap_gene_dataset,
})

CCSLIC_umap_proj_config = CCSLIC_config.copy({
    'dataset': CCSLIC_umap_proj_dataset,
    'proj_file_name':'umap_1.pkl',
})
