...
def calculate_means(pred, gt, n_objects, max_n_objects, usegpu):
    ...
    for i in range(bs):
        ...
        if _n_objects_sample == 0:
            ...
            if torch.sum(torch.isnan(_mean_sample)) > 0:
                print('_mean_sample',_gt_expanded_sample.sum(0))
...
def discriminative_loss(input, target, n_objects,
    ...
    #print('var: ',var_term,', dist: ',dist_term,', reg: ',reg_term)
