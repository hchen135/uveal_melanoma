...
All images are saved to ```Shell CONFIG.INPUT\_DIR```/Slide */*.png
The image name is $A$\_TileLoc\_$B$\_$C$.png. A is the tile ind, B, C means the top-left corner of the image is Bx512 and Cx512.
